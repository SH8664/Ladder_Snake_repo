...
public:
	...
	Card* GetCard(CellPosition cardpos);
	void SaveAll(ofstream &OutFile,Type type);


	void SetIntialAttemps();
	////////////////////////////////////////fatma
	//////////////////////////////////////

	void ToFirstCell(CellPosition firstcell);
	void RemoveStations();
	void SetInitialWallet();
	void ApplyGameObject(Player* player);
	void SetPlayerTurn();
	void SetCurrentPlayerNum(int);
	Player* GetMinPlayerWallet(Player* pmin);
