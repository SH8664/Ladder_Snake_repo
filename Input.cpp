...
ActionType Input::GetUserAction() const
{
	...
	if (UI.InterfaceMode == MODE_DESIGN)
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_dELRTE_GAME_OBJECT: return dELRTE_GAME_OBJECT;
	...
	else
	{
		...
		case	ITM_ROLL_DICE: return ROLL_DICE;		// Roll Dice Action
		case	ITM_SWITCH_TO_DESIGN_MODE: return TO_DESIGN_MODE;	// Go to Design Mode
