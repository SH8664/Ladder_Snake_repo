...
enum DESIGN_MODE_ITEMS // The items of the Design Mode (you should add more items)
{
	...
	ITM_ADD_LADDER,		// Add Ladder Action
	ITM_ADD_SNAKE,		// Add Snake Action	
	ITM_ADD_CARD,       // Add Card Action
	ITM_EXIT,			// Exit Application
	ITM_SWITCH_TO_PLAY_MODE,
	ITM_COPY_CARD,
	ITM_CUT_CARD,
	ITM_PASTE_CARD,
	ITM_dELRTE_GAME_OBJECT,
	ITM_SAVE_GRID,
	ITM_OPEN_GRID,
...
enum PLAY_MODE_ITEMS // The items of the Play Mode (you should add more items)
{
	...
	ITM_ROLL_DICE,		// Roll Dice Action
	ITM_SWITCH_TO_DESIGN_MODE,	// Go to Design Mode
